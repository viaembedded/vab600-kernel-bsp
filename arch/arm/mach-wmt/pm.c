...
//gri
	...
	printk("[%s] var define var_wake_en=%x var_wake_param=%x var_wake_type=%x var_wake_type2=%x\n",
	__func__, var_wake_en, var_wake_param, var_wake_type, var_wake_type2);
