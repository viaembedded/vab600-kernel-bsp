...
/* 	=============================================================================
	...
	SDA			0		tvsys						tvconn
	SDD			1		tvsys						tvconn
	LCD			2		lcd id						bit per pixel(bit0-7),b8(1:blank),b9-11(igs mode),bit12-13(swap)
	DVI			3		colfmt						b0(0:12bit,1:24bit),b1(1:interlace),b8(1:blank),b9-11(igs mode),bit12-13(swap)
