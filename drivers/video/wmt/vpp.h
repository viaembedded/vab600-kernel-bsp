...
typedef struct {
	...
	unsigned int govw_fb_mb[VPP_GOVW_SCL_MB_NUM];
	vpp_fb_pool_t govw_fb_pool;
#endif
	...
	int govrh2_vbis_cnt;		// count for GOVR VBIS interrupt
...
const unsigned int vpp_csc_parm[VPP_CSC_MAX][7] = {
	...
	{0x02590132, 0x1f530075, 0x02001ead, 0x1e530200, 0x00011fad, 0x01010001, 0x00000000},	//RGB2YUV_JFIF_0_255	// HDMI YUV mode too light 0xff00ff -> 0x01010001
...
const char *vpp_vpath_str[] = {"GOVW","GOVR","GE","VPU","SCL","AUTO","GOVSCL","MAX"};
const char *vpp_mod_str[] = { "GOVRH2","GOVRH","DISP","GOVW","GOVM","SCL","SCLW","VPU","VPUW","PIP","VPPM","LCDC","CUR","MAX"};
...
EXTERN void vpp_mod_set_clock(vpp_mod_t mod,vpp_flag_t enable,int force);
