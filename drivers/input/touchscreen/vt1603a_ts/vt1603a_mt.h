...
#define TS_DEBOUNCE    10 /* VIA modification with shorter bouncing < 10ms as Powertip panel spec said */
//#define TS_READ_DELAY  10
#define TS_READ_DELAY  25 /* VIA modification with longer delay time =25 ns for Powertip 800x480 touch panel */
