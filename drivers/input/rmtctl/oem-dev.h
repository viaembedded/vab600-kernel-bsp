...
EXTERN struct rmt_dev  rmt_dev_tbl[ ] = {
	...
	#endif
	#ifdef RMCTL_NEC_08F7
	{
		.vendor_name = "NEC_08F7",
		.vender_id = 0x08f7,
		.key_codes = {
			[0x00] = KEY_RESERVED,      /* TOUR */
			[0x01] = KEY_MUTE,    	    /* MUTE */
			[0x02] = KEY_RESERVED,      /* IRIS+ */
			[0x05] = KEY_RESERVED,      /* AUTO */
			[0x06] = KEY_RESERVED,      /* RESERVED - 16 */
			[0x0b] = KEY_RECORD,  	    /* REC */
			[0x0c] = KEY_RESERVED,      /* LOCK */
			[0x0d] = KEY_0,
			[0x16] = KEY_7,
			[0x19] = KEY_9,
			[0x1a] = KEY_4,
			...
			[0x1f] = KEY_1,
			[0x40] = KEY_6,
			[0x41] = KEY_RESERVED,      /* PIP */
			[0x46] = KEY_8,
			[0x4a] = KEY_ZOOM,	    /* ZOOM */
			[0x4b] = KEY_RESERVED,      /* +10 */
			[0x4d] = KEY_RESERVED,      /* RESERVED - 9 */
			[0x4e] = KEY_FASTFORWARD,   /* forward */
			[0x4f] = KEY_ESC, 	    /* ESC */
			[0x52] = KEY_RESERVED,      /* OSD */
			[0x53] = KEY_RESERVED,      /* PTZ */
			[0x54] = KEY_RESERVED,      /* IRIS- */
			[0x55] = KEY_RESERVED,      /* RESERVED - 13 */
			[0x57] = KEY_PLAY,	    /* PLAY */
			[0x59] = KEY_5,
			[0x5a] = KEY_ENTER,	    /* ENTER */
			[0x5b] = KEY_VOLUMEUP, 	    /* vol+ */
			[0x5c] = KEY_VOLUMEDOWN,    /* vol- */
			[0x5d] = KEY_RESERVED,      /* RESERVED - 4 */
			[0x5e] = KEY_REWIND,	    /* rewind */
			[0x5f] = KEY_MENU     	    /* MENU */
		},
	},
	#endif
